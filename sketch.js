...
title2.html("1.  move your mouse so your bolloon will be moving up and down")
title2.position(window.innerWidth/2-600,500)

title3 = createElement("H2")
title3.html("2. collect coins to make highest score")
...
function draw() {
 ...
 for(var i = 0; i<birdsGroup.length; i++){
  if(birdsGroup.get(i).isTouching(airbaloon)){
    score = score ;
   birdsGroup[0].destroy();
    alert("gameover/ better luck next time score "+score)
